...
A superlightweight , terminal executable Java system designed for resrce allocation and priority dispatching in disconnected disaster zone.

## overview
This application provides local inventry persistence and queue-based resource dispatch processing without requiring remote database connections or heavy graphical dependencies, it will bevery useful in flood affected places
//
## key Features
